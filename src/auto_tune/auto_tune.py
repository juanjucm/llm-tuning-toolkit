...
class AutoTuner:
    ...
    def _find_optimal_rate(self,
                           max_throughput: float,
                           run_id: str,
                           output_folder: str,
                           engine_config: Dict) -> Tuple[Dict, List[Dict]]:
    ...
    def run_auto_tune(self) -> Dict:
        ...
        for i, param_config in enumerate(param_combinations, 1):
            ...
            try:
                ...
                self.logger.info(f"Goodput criteria met! Max throughput: {metrics['throughput']:.2f} req/s for this configuration.")
